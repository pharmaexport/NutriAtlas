      ...
      <section className="pageSection profileFormPreview">
        <form className="profileEditor" onSubmit={(event) => { event.preventDefault(); saveQuestionnaire(); }}>
          ...
          <div className="formGrid">
            ...
            <label className="field"><span>Fréquence repos</span><input type="number" inputMode="numeric" value={questionnaire.restingHeartRate ?? ""} onChange={(event) => updateNumber("restingHeartRate", event.currentTarget.value)} /><small>bpm, optionnel</small></label>
          </div>
